package com.spotifybot.presentation.api;
...
import com.spotifybot.application.service.OrderService;
import com.spotifybot.presentation.dto.*;
 ...
 * 
 * Implements Perfect Panel API specification for SMM panel integration.
 * Endpoints: /api/v2/add, /api/v2/status, /api/v2/services, etc.
 * 
 * @see <a href="https://perfectpanel.com/docs/api/v2">Perfect Panel API Docs</a>
 */
@RestController
