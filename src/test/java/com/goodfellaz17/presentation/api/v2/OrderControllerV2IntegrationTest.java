...
class OrderControllerV2IntegrationTest {
    ...
    // Test data
    private static final String TEST_API_KEY = "test-api-key-integration-" + UUID.randomUUID();
    ...
    private void seedTestData() {
        ...
        UserEntity testUser = UserEntity.builder()
            .email("test-integration@goodfellaz17.com")
    ...
    @Disabled("TODO: Fix test isolation - depends on state from shouldCreateOrderSuccessfully")
    ...
    @Test
    @Order(6)
    @DisplayName("GET /api/v2/orders/balance - Should return correct balance")
    @Disabled("TODO: Fix test isolation - balance depends on prior order creation tests")
    ...
    @Disabled("TODO: Fix test isolation - depends on balance state from prior tests")
    ...
    @Disabled("TODO: Fix test isolation - depends on orders created by prior tests")
